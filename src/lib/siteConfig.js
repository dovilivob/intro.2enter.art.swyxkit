export const SITE_URL = 'https://2enter.netlify.app';
export const APPROVED_POSTERS_GH_USERNAME = ['sw-yx'];
export const GH_USER_REPO = 'dovilivob/'; // used for pulling github issues and offering comments
export const REPO_URL = 'https://github.com/' + GH_USER_REPO;
export const SITE_TITLE = '2enter Studio';
